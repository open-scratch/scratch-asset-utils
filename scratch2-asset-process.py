...
PRE = ""
# 缩略图路径
PATH_THUMB = PRE + "scratch2\\scratchr2\\static\\medialibrarythumbnails\\"
# 资源路径
PATH_ASSET = PRE + "scratch2\\internalapi\\asset\\"
# 索引库目录
PRE_LIB = PRE + "scratch2\\scratchr2\\static\\medialibraries\\"
# 背景索引
